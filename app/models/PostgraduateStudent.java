...
@Entity
public class PostgraduateStudent extends Model {
    ...
    public PostgraduateStudent(String stu_id, String name,
    ...
    public static PostgraduateStudent connect(String tea_id, String passawd) {
